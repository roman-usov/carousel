...
const getElement = {
  ...
  buttonPrev: (slider) =>
    within(slider).getByRole("button", { name: "Previous" }),
  slide: (slider, name) =>
    within(slider).getByRole("img", { name: new RegExp(name, "im") }),
};
...
test("Next button, first slider", async () => {
  ...
  await userEvent.default.click(buttonNext1);
  ...
  await userEvent.default.click(buttonNext2);
...
test("Prev button, second slider", async () => {
  ...
  await userEvent.default.click(buttonPrev1);
  ...
  await userEvent.default.click(buttonPrev2);
  await userEvent.default.click(buttonPrev2);
